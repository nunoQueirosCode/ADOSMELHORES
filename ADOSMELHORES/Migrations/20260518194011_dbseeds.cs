    ...
    public partial class dbseeds : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), null, true, "912345678", new DateTime(2028, 12, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2026, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), true, "", "Mário Oliveira", 3500.00m, "Diretor" });

            migrationBuilder.InsertData(
                table: "Funcionarios",
                columns: new[] { "Id", "Contacto", "DataFimContrato", "DataRegistoCriminal", "Morada", "Nome", "Coordenador_Salario", "TipoFuncionario" },
                values: new object[] { new Guid("22222222-2222-2222-2222-222222222222"), "962345678", new DateTime(2026, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2026, 4, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "", "Nuno Queirós", 2200.00m, "Coordenador" });
